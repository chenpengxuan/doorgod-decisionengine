...
import com.ymatou.doorgod.decisionengine.util.ThreadContext;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (target instanceof Executor) { // 获取分页总数，更改分页sql
            ...
            if (pageable != null && pageable.getPageSize() != -1) {
                ...
                // 得到总记录数
                long totalRecord = SQLHelper.getCount(DIALECT, originalSql, connection, mappedStatement,
            ...
            try {
                ParameterHandler parameterHandler =
                        (ParameterHandler) metaResultSetHandler.getValue("parameterHandler");
